<?php
/**
 * Template Name: Телевидение бизнес
 */
get_header();
?>
...
<?php get_template_part( 'partials/break-news'); ?>
    ...
    <main class="main tv-business">

        <!-- main tv rates -->
        <section class="rate-section">
            <div class="wrap-section-title">
                <div class="container">
                    <h1 class="section-title-h1">Публичные тарифы</h1>
                </div>
            </div>
            <div class="container">
                <?php
        ...
        <section class="rate-section rate-tv-extra-options">
            <div class="wrap-section-title">
                <div class="container">
                    <h1 class="section-title-h1">Дополнительные опции для публичного тарифа</h1>
                </div>
            </div>
            <div class="container">
        ...
        <section class="rate-section">
            <div class="wrap-section-title">
                <div class="container">
                    <h1 class="section-title-h1">Для гостиниц и отелей</h1>
                </div>
            </div>
            <div class="container">
                <?php
                $rates_tv = get_field('rates-tv-hotel');
                foreach ( $rates_tv as $rate ) :
                    $id = $rate->ID;
                    $rate_title = $rate->post_title;
                    $rate_count_channels = get_field('rate-tv-count-channels', $id);
